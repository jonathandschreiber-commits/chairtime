...
from app.schemas import SignupCreate, UserLogin
...
def signup(
    ...
    try:
        ...
        # Flush creates the shop ID
        # without permanently committing.
        # This lets the shop and owner
        # be created together as one
        # transaction.
        db.flush()
